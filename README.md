# [Snipster](https://snipster.netlify.app/)

Snipster is a fully functional tool for sharing code snippets with additional features. Share beautiful screenshots of your code on your social media platforms with 10+ elegant themes (light + dark theme included) and 12+ font styles (popular monospace fonts). The application provides support for all popuplar languages with auto-detection and syntax highlighting.

**Project live at:** [https://snipster.netlify.app/](https://snipster.netlify.app/)
